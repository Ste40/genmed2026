...
Usa questo blocco **in una cella Jupyter**. Devi modificare solo `CASE_NUM`.
...
Esempi rapidi:
- `CASE_NUM = 1` carica `results/case01/...`
- `CASE_NUM = 7` carica `results/case07/...`
- `CASE_NUM = 10` carica `results/case10/...`
